...
export default function Reviews() {
  const data = [
    ...
    { n: 'Ridhi Saluja', loc: 'Sector 56', r: 'The services have definitely improved from the first time. Preferences are kept as top priority. Thank you for making our lives easier with Kynd!' },
    ...
    <section id="reviews" className="py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold text-neutral-900">Loved by Kynd<br />homes.</h2>
